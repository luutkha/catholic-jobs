                        ...
                        <div className=" flex items-center p-5 w-full">
                            ...
                            <div className="w-full hidden md:block">
                                <div className="w-full flex flex-row justify-center items-center gap-5 text-sm">
                                    <Link href="/#">
                                        <div className=" text-primary hover:text-black cursor-pointer dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                                            Home 1
                                        </div>
                                    </Link>
                                    <Link className="text-gray-800 dark:text-white  hover:text-primary dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium" href="/#">
                                        Gallery
                                    </Link>
                                    ...
                                    <div className="relative inline-block text-left">
                                        ...
                                        <div className="absolute right-0 w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg dark:bg-gray-800 ring-1 ring-black ring-opacity-5">
                                            {/* <div className="py-1 " role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                                                <Link href="#" className="block block px-4 py-2 text-md text-gray-700 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-100 dark:hover:text-white dark:hover:bg-gray-600" role="menuitem">
